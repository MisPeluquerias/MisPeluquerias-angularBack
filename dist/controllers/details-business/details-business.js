...
router.post("/saveReview", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      VALUES (?, ?, ?, ?)
    `;
        db_1.default.query(query, [usuarioId, id_salon, observacion, qualification], (error, results) => {
            if (error) {
